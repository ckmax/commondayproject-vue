        ...
        <Content v-bind:theme="blackTheme">
          <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
              ...
              <p class="text-white-50">Rutgers University, Cell Bio and Neuroscience major | Senior Analyst at Samsung</p>
        ...
        <Content v-bind:theme="whiteTheme">
          <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
              ...
              <p class="text-black-50">Rutgers University, Statistics major | ??? at Humanscale</p>
